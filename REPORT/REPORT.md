...
| GitHub リポジトリ | https://github.com/nillsmith890-hash/todo-list |
...
本レポートでは、他者のコードや文章の直接引用は使用していない。ソースコードは `todo.py`、単体テストは `test_todo.py`、保存データは `tasks.json` として、レポート PDF と同時に提出する。また、ソースコードは以下の GitHub リポジトリにも保存している。

https://github.com/nillsmith890-hash/todo-list
